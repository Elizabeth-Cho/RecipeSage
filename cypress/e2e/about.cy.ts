describe('about', () => {
  ...
  it('details displayed correctly', () => {
    ...
    cy.url().should('eq', 'https://recipesage.com/#/about/details')
    ...
    cy.url().should('eq', 'https://recipesage.com/#/contribute')
  })
...
describe('contact', () => {
  ...
  it('correct url and title', () => {
    ...
    cy.url().should('eq', 'https://recipesage.com/#/about/contact')
...
describe('Legal, agreements and disclaimers', () => {
  ...
  it('correct url and title', () => {
    ...
    cy.url().should('eq', 'https://recipesage.com/#/legal')
  ...
  it('return back to about', () => {
    ...
    cy.url().should('eq', 'https://recipesage.com/#/about' )
  })
